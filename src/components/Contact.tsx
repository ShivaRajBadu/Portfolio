    ...
    <div id="contact" className="py-16 bg-grey-900">
      <Wrapper>
        <div>
          ...
          <p className="text-xl md:text-2xl  text-grey-500 px-2 p-6 md:max-w-[60%] mx-auto  font-semibold font-inter text-center  ">
          ...
          <h1 className=" text-xl sm:text-2xl md:text-3xl py-2 text-center text-grey-400 font-roboto font-bold flex gap-4 justify-center items-center ">
            <svg
              viewBox="0 0 8 10"
              className="fill-grey-400 w-[20px] h-[20px] md:w-[30px] md:h-[30px]"
              xmlns="http://www.w3.org/2000/svg"
            >
