...
const AboutMe = () => {
  return (
    <div className="bg-grey-900 py-10 px-4">
      <Wrapper>
        <SectionTitle title="About me" />
        <div className="flex md:flex-row flex-col justify-center md:justify-between gap-4 items-start py-16">
          <MainImage
          ...
          <div className="w-full  md:w-[50%]">
            <h3 className="text-2xl md:text-4xl pb-2 font-medium font-inter">
